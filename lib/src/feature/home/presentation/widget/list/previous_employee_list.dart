...
class PreviousEmployeeList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PreviousEmployeeList> createState() => _EmployeeListState();
}

class _EmployeeListState extends ConsumerState<PreviousEmployeeList> {
  @override
              ...
              child: ListView.builder(
                ...
                itemBuilder:
                    (context, index) => EmployeeTile(
                      ...
                      from: DateFormats.dMmmy.format(widget.list[index].start!),
                      to: DateFormats.dMmmy.format(widget.list[index].end!),
                      onEdit: () {
